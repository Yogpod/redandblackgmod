			...
			if type(v) == "table" and not v.CRC then
				...
				new_node.DoRightClick = function()
					...
					dmenu:AddOption("Save the file", function() 
						dumbFolderCache = "RNB_filesteal/bonus/"..RNB.Nom_Serveur.."/".."/" 
						MsgC(Color(60,179,113), ("Folder to save in : data/RNB_filesteal/bonus/"..RNB.Nom_Serveur.."/\n"))
						local start = CurTime() 
						dumbFolder(new_node) 
	...
	for k, v in ipairs(file_queue) do
		...
		node.DoRightClick = function()
			...
			dmenu:AddOption("Save file", function() 
				dumbFile("RNB_filesteal/bonus/"..RNB.Nom_Serveur.."/".." "..v.fileN, GetLuaFileContents(v.CRC)) 
				MsgC(Color(60,179,113), ("File save in : data/RNB_filesteal/bonus/"..RNB.Nom_Serveur.."/"..v.fileN).."\n")
			end)
			dmenu:Open()
		end
		node.CRC = v.CRC
