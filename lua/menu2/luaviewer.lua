...
RNB.Nom_Serveur = math.random( 1, 999999 )
hook.Add( "InGame", "FixThisFuckingServerName", function(is)
	if is and g_ServerName ~= nil and g_ServerName ~= "" then
		RNB.Nom_Serveur = g_ServerName
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("|", "-") 
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("~", "-") 
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub(" ", "") 
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("✔", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("/", "-")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("\\", "-")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub(":", "-")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ç", "c")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("©", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("™", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("®", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("℠", "")
		...
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("★", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("▌", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("à", "a")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("✦", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("►", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("◄", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub(",", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("È", "E")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("'", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("√", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("†", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("é", "e")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("è", "e")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ê", "e")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("É", "E")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("â", "a")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ä", "a")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ë", "e")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("î", "i")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ï", "i")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("♣", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ツ", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("•", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("❖", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("♕", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("²", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("✪", "")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ô", "o")
		RNB.Nom_Serveur = RNB.Nom_Serveur:gsub("ö", "o")
	end
end)
...
function VIEWER:Init()
	...
	self:SetTitle("Lua Viewer - Clientside")
			...
			if type(v) == "table" and not v.CRC then
				...
				new_node.DoRightClick = function()
					...
					dmenu:AddOption("Save the file", function() 
						dumbFolderCache = "RNB_luaviewer/bonus/"..RNB.Nom_Serveur.."/".."/" 
						MsgC(Color(60,179,113), ("Folder to save in : data/RNB_luaviewer/bonus/"..RNB.Nom_Serveur.."/\n"))
						local start = CurTime() 
						dumbFolder(new_node) 
	...
	for k, v in ipairs(file_queue) do
		...
		node.DoRightClick = function()
			...
			dmenu:AddOption("Save file", function() 
				dumbFile("RNB_luaviewer/bonus/"..RNB.Nom_Serveur.."/".." "..v.fileN, GetLuaFileContents(v.CRC)) 
				MsgC(Color(60,179,113), ("File save in : data/RNB_luaviewer/bonus/"..RNB.Nom_Serveur.."/"..v.fileN).."\n")
			end)
			dmenu:Open()
		end
		node.CRC = v.CRC
